...
class Snapshot(BaseModel):
    ...
    actor: str                  # who/what: "vignesh", "gondola-watcher", "ci-pipeline"
    event_type: str             # free-form: "registered", "introspected", "validated", etc.
    source: str | None          # where the data came from: "gondola", "squarewave", "manual"
...
Block adds: `SquareWaveWatcher`, `SnoopWatcher`, `GondolaWatcher`.
...
model-ledger record "arr-v3" --event introspected --source gondola --payload '{"algorithm": "XGBoost"}'
